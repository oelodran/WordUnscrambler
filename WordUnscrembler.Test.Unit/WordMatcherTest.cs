...
namespace WordUnscrembler.Test.Unit
{
    [TestClass]
    public class WordMatcherTest
    {
        ...
        [TestMethod]
        public void ScrambledWordMatchesGivenWordTheList()
        {
        ...
        public void ScrambledWordMatchesGivenWordsTheList()
        {
            string[] words = { "cat", "chair", "more" }; 
            ...
            Assert.IsTrue(matchedWords[0].ScrambledWord.Equals("omre"));
            Assert.IsTrue(matchedWords[0].Word.Equals("omre"));
